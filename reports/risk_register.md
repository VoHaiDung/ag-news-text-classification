...
|     | base image                                                    |        |            |        |                                                                                          |
| R05 | Free-tier hosted-demo CPU is too slow for the SHAP demo       | 8      | Medium     | Medium | Materialised: the project ships a local Gradio demo and a public GitHub repository instead of a hosted Space; SHAP runs on the local CPU on demand. |
