...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=[
            # Primary larger models that clear the >=95% F1-macro target.
            PROJECT_ROOT / "configs" / "models" / "deberta_v3_base.yaml",
            PROJECT_ROOT / "configs" / "models" / "modernbert_large.yaml",
        ],
    )
